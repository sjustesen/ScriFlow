...
import { Expression, SourceFile, Program, TaggedTemplateExpression, FormatCodeSettings, Node, CompilerOptions, Diagnostic, TextSpan } from "typescript";
import { AnalyzeComponentsResult, ComponentDefinition, ComponentDiagnostic, ComponentDeclaration, ComponentMember, ComponentSlot, EventDeclaration } from "web-component-analyzer";
...
interface LitHtmlDiagnosticComplexNotAssignableToPrimitive extends LitDocumentDiagnosticBase {
...
declare type LitHtmlDiagnostic = LitHtmlDiagnosticUnknownTag | LitHtmlDiagnosticMissingImport | LitHtmlDiagnosticMissingProps | LitHtmlDiagnosticHtmlBoolMod | LitHtmlDiagnosticUnknownMember | LitHtmlDiagnosticHtmlDirectiveNotAllowedHere | LitHtmlDiagnosticPrimitiveNotAssignableToComplex | LitHtmlDiagnosticHtmlInvalidAttributeExpressionType | LitHtmlDiagnosticHtmlInvalidAttributeExpressionTypeUndefined | LitHtmlDiagnosticHtmlNoEventListenerFunction | LitHtmlDiagnosticComplexNotAssignableToPrimitive | LitHtmlDiagnosticHtmlPropertyNeedsExpression | LitHtmlDiagnosticHtmlExpressionOnlyAssignableWithBooleanBinding | LitHtmlDiagnosticInvalidSlotName | LitHtmlDiagnosticMissingSlotAttr | LitHtmlDiagnosticTagNotClosed;
...
declare type ChangedSourceFileIterator = ((sourceFiles: ReadonlyArray<SourceFile>) => Iterable<SourceFile>) & {
...
declare function translateRange(range: DocumentRange): TextSpan;
declare function generateSourceFileErrorText(file: SourceFile, textSpan: TextSpan, message: string): string;
declare function markText(text: string, range: TextSpan): string;
export { LitAnalyzer, LitAnalyzerConfig, makeConfig, LitAnalyzerContext, LitAnalyzerRequest, LitPluginContextHandler, LitAnalyzerLogger, DefaultLitAnalyzerLogger, DefaultLitAnalyzerContext, LitClosingTagInfo, CodeFixKind, CodeFixBase, CodeFixAddText, CodeFixRename, CodeFixChangeLitModifier, CodeFixImportComponent, LitCodeFix, DocumentTextChange, TextChange, CodeActionKind, CodeActionTextChange, CodeActionImportComponent, LitCodeFixAction, LitCompletion, LitCompletionDetails, DefinitionKind, DefinitionBase, DefinitionComponent, DefinitionMember, DefinitionEvent, LitDefinition, LitHtmlDiagnosticKind, LitDiagnosticBase, LitDocumentDiagnosticBase, LitSourceFileDiagnosticBase, LitHtmlDiagnosticUnknownTag, LitHtmlDiagnosticUnknownMember, LitHtmlDiagnosticMissingImport, LitHtmlDiagnosticMissingProps, LitHtmlDiagnosticTagNotClosed, LitHtmlDiagnosticHtmlBoolMod, LitHtmlDiagnosticPrimitiveNotAssignableToComplex, LitHtmlDiagnosticHtmlNoEventListenerFunction, LitHtmlDiagnosticHtmlInvalidAttributeExpressionType, LitHtmlDiagnosticHtmlInvalidAttributeExpressionTypeUndefined, LitHtmlDiagnosticHtmlExpressionOnlyAssignableWithBooleanBinding, LitHtmlDiagnosticComplexNotAssignableToPrimitive, LitHtmlDiagnosticHtmlPropertyNeedsExpression, LitHtmlDiagnosticHtmlDirectiveNotAllowedHere, LitHtmlDiagnosticInvalidSlotName, LitHtmlDiagnosticMissingSlotAttr, LitHtmlDiagnostic, LitCssDiagnostic, LitSourceFileDiagnostic, LitDiagnostic, LitFormatEdit, LitOutliningSpanKind, LitOutliningSpan, LitQuickInfo, SourceFileRange, DocumentRange, RenameInfoBase, RenameHtmlNodeInfo, RenameComponentDefinitionInfo, LitRenameInfo, LitRenameLocation, LitTargetKind, cli, translateRange, generateSourceFileErrorText, markText };
